...
Large generated datasets, sparse matrices, and trained model artifacts do not need to be committed to GitHub unless you explicitly want to distribute them.

The repository focuses on reproducible notebooks, documented methodology, and a leakage-aware machine learning workflow.
